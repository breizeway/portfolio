...
### Skills
Python, JavaScript, React.js, Redux, HTML5, CSS3, Express, Flask, PostgreSQL, Sequelize, SQLAlchemy, Docker, AWS, Gatsby, GraphQL, Heroku, Git, Node.js, Visual Studio Code, MacOS, Windows, Microsoft SQL Server, RESTful APIs, full-stack software development, object-oriented programming, application development, web development, project management, leadership, data harvesting, personnel management, and <Link to='/technologies'>more</Link>...

### Projects
I have built several websites using modern web technologies and frameworks, both solo and as part of a team of developers. Learn more about these projects <Link to='/projects'>here</Link>.
